...
const JobminePortfolioPage = () => (
  <React.Fragment>
    <NavBar />
    <PortfolioPageHeader
      mainHeading="Jobmine"
      keywords="UI/UX Design | Human Factors"
    ...
    <MainSection>
      <MainText>
        ...
        Jobmine, a job board for the University of Waterloo, was being used by
        thousands of students every year. However, the poor user experience
        often resulted in non-intentional actions from the user.
        <IntroImage src={jobmineOld} alt={jobmineOld} />
        <MainTextHeading>Goal:</MainTextHeading>
        Redesign Jobmine to have a better user experience, with a focus on Human
        Factors.
        ...
        <FlexWrapper>
          ...
          <SprintImageCaption>
            ...
            with the design was the size of the font, and the poor usage of the
            full screen.
          </SprintImageCaption>
          ...
          <SprintImageCaption>
            ...
            A primary and secondary persona were then defined - Ming, a student,
            and John, an employer. As depicted above, we went in depth into each
            persona to make them as realistic as possible. However, due to time
            and authorization constraints and no access to an employer's point
            of view of Jobmine, John was not included in the rest of the
            analysis.
          </SprintImageCaption>
          ...
          <SprintImageCaption>
            ...
            being said, we primarily focused on Security concerns with Jobmine.
          </SprintImageCaption>
          ...
          <SprintImageCaption>
            ...
            Model, Feedback, Affordances, Signifiers, Mapping, and Constraints.
            This helped us notice a lot of flaws in the design that we missed in
            Part 2. Analysis of Current Design, specifically regarding feedback
            and affordances.
          </SprintImageCaption>

          <SprintImageCaption>
            <MainTextSubHeading>6. Heuristic Evaluation</MainTextSubHeading>
            <ProcessImage src={heuristicEvaluation} alt={heuristicEvaluation} />
            Based on the 7 Principles of Universal Design, Jobmine was further
            analyzed. Similar to some of the other tools, certain sections were
            not very useful, for example, Low Physical Effort.
          </SprintImageCaption>
          ...
          <SprintImageCaption>
            ...
            Similar to the FTA, we broke down every single step Ming had to take
            when using Jobmine. This helped us find a lot of unnecessary and
            repetitive steps, that could be improved upon.
          </SprintImageCaption>
...
export default JobminePortfolioPage;
