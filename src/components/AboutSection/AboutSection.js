    ...
    >
      <TextAvatarGroup>
        ...
        <AvatarText>
          ...
          I&#39;m a third year student studying Systems Design Engineering at
          the University of Waterloo, and an aspiring engineer and designer.
          I&#39;ve had the privilege of completing 4 outstanding tech
          internships in 3 different countries, and am currently in search of a
          new internship opportunity for September to December 2018. Check out
          my resume{' '}
          <span
            onClick={() => {
              window.open(Resume);
      ...
      <TextAvatarGroup>
        ...
        <AvatarText>
          ...
          I spend most of my days working towards my degree, and am especially
          interested in learning and understanding the design process. I love a
      ...
      <TextAvatarGroup>
        ...
        <AvatarText>
          ...
          EAT. I hope to continue travelling, trying new cuisines, and going to
          as many restaurants as I can on the world top 50 list. I guess I play
          some sports too to compensate.
        </AvatarText>
      </TextAvatarGroup>
    </MainSection>
  </React.Fragment>
